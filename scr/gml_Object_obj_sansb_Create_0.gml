...
ini_f = ini_read_real(("Sans" + string(global.filechoice)), "F", 0)
intro = ini_read_real(("Sans" + string(global.filechoice)), "Intro", 0)
ini_write_real(("Sans" + string(global.filechoice)), "F", (ini_f + 1))
ossafe_ini_close()
