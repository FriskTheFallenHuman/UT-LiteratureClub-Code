if (conversation == 1 && instance_exists(obj_dialoguer) == 0)
{
    ...
    if global.charswap
    {
        obj_toroverworld3.rsprite = spr_toriel_monika_handhold_r
        obj_toroverworld3.usprite = spr_toriel_monika_handhold_u
        obj_toroverworld3.sprite_index = spr_toriel_monika_handhold_r
    }
    else
    {
...
if (conversation == 3 && instance_exists(obj_dialoguer) == 0)
{
    ...
    with (obj_toroverworld3)
        visible = false
    if global.charswap
        ruff = scr_marker(obj_toroverworld3.x, obj_toroverworld3.y, spr_toriel_monika_ruffle)
    else
