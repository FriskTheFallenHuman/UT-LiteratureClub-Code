...
{
    global.msg[0] = scr_gettext(("obj_readable_room4_63" + string(char_name)))
    if (global.flag[7] == 1)
        global.msg[0] = scr_gettext("obj_readable_room4_64")
}
if (room == room_torhouse3 && murdererlv1() == 1)
    global.msg[0] = scr_gettext(("obj_readable_room4_66" + string(char_name)))
...
if (room == room_kitchen && x > 130)
    global.msg[0] = scr_gettext(("obj_readable_room4_78" + string(char_name)))
if (room == room_kitchen && x > 130 && global.flag[45] == 4)
    global.msg[0] = scr_gettext(("obj_readable_room4_79" + string(char_name)))
