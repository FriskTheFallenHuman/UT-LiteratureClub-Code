...
if (cn == 162)
{
    if (choice == 0)
    {
        ...
        ini_write_real(("Alphys" + string(global.filechoice)), "R", 1)
        ossafe_ini_close()
    ...
    {
        ossafe_ini_open("undertale.ini")
        ini_write_real(("Alphys" + string(global.filechoice)), "R", 2)
        ossafe_ini_close()
        ossafe_savedata_save()
...
if (cn == 170)
{
    ...
    ini_write_real(("Alphys" + string(global.filechoice)), "AD", (adhd + 1))
    ossafe_ini_close()
    ossafe_savedata_save()
