...
if (global.myfight == 2)
{
    if (whatiheard != -1)
    {
        if (global.heard == 0)
        {
            ...
            {
                global.msc = 0
                global.msg[0] = scr_gettext(("obj_fakefroggit_508" + string(char_name)))
                if global.charswap
                    global.msg[1] = scr_gettext(("obj_fakefroggit_508a" + string(char_name)))
                OBJ_WRITER.halt = 3
                iii = instance_create(global.idealborder[0], global.idealborder[2], OBJ_WRITER)
                with (iii)
                    halt = false
            ...
            {
                global.msc = 0
                global.msg[0] = scr_gettext(("obj_fakefroggit_518" + string(char_name)))
                if global.charswap
                    global.msg[1] = scr_gettext(("obj_fakefroggit_518a" + string(char_name)))
                OBJ_WRITER.halt = 3
                iii = instance_create(global.idealborder[0], global.idealborder[2], OBJ_WRITER)
                with (iii)
                    halt = false
