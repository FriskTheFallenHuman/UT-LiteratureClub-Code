if (global.plot == 0.1)
{
    ...
    if (alter == 0)
    {
        ...
        g = ini_read_real(("Flowey" + string(global.filechoice)), "Met1", 0)
        ...
        {
            global.msc = 0
            ini_write_real(("Flowey" + string(global.filechoice)), "Alter", 1)
        ...
        ini_write_real(("Flowey" + string(global.filechoice)), "Met1", (g + 1))
        ossafe_ini_close()
