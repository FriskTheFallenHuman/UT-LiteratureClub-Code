...
if (room == room_torielroom)
{
    ...
    if (x > 90)
    {
        global.msg[0] = scr_gettext(("obj_readable_room2_127" + string(char_name)))
...
{
    global.msg[0] = scr_gettext(("obj_readable_room2_135" + string(char_name)))
    if (global.flag[50] == 1)
        global.msg[0] = scr_gettext("obj_readable_room2_136")
}
if (room == room_kitchen)
{
    global.msg[0] = scr_gettext(("obj_readable_room2_140" + string(char_name)))
    if (global.flag[103] > 0)
        global.msg[0] = scr_gettext(("obj_readable_room2_141" + string(char_name)))
    if (global.flag[7] == 1)
        global.msg[0] = scr_gettext(("obj_readable_room2_144" + string(char_name)))
}
