...
if (conversation == 1)
{
    ...
    TS = ini_read_real(("Toriel" + string(global.filechoice)), "TS", 0)
    FS = ini_read_real(("Flowey" + string(global.filechoice)), "FloweyExplain1", 0)
    ossafe_ini_close()
    ...
    if (global.flag[45] == 4)
    {
        ...
        {
            ossafe_ini_open("undertale.ini")
            ini_write_real(("Flowey" + string(global.filechoice)), "FloweyExplain1", 1)
            ossafe_ini_close()
            needsave = 1
        ...
        {
            ossafe_ini_open("undertale.ini")
            ini_write_real(("Flowey" + string(global.filechoice)), "truename", 1)
            ini_write_real(("Flowey" + string(global.filechoice)), "alter2", 1)
            ossafe_ini_close()
            needsave = 1
