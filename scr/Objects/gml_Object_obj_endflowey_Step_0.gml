if (con == 1)
{
    ...
    AF = ini_read_real(("Flowey" + string(global.filechoice)), "AF", 0)
    AK = ini_read_real(("Flowey" + string(global.filechoice)), "AK", 0)
    NK = ini_read_real(("Flowey" + string(global.filechoice)), "NK", 0)
    IK = ini_read_real(("Flowey" + string(global.filechoice)), "IK", 0)
    CK = ini_read_real(("Flowey" + string(global.filechoice)), "CK", 0)
    CHANGE = ini_read_real(("Flowey" + string(global.filechoice)), "CHANGE", 0)
    EX = ini_read_real(("Flowey" + string(global.filechoice)), "EX", 0)
    truename = ini_read_real(("Flowey" + string(global.filechoice)), "truename", 0)
    ossafe_ini_close()
    if (EX == 0)
        con = 100
    if (EX == 1)
...
{
    ossafe_ini_open("undertale.ini")
    ini_write_real(("Flowey" + string(global.filechoice)), "NK", 1)
    ossafe_ini_close()
    ...
    if (ossafe_file_exists(("file" + string(global.filechoice))) == 0)
...
{
    ossafe_ini_open("undertale.ini")
    ini_write_real(("Flowey" + string(global.filechoice)), "AF", 1)
    ossafe_ini_close()
    ossafe_savedata_save()
    global.msc = 0
    global.typer = 120
...
{
    ossafe_ini_open("undertale.ini")
    ini_write_real(("Flowey" + string(global.filechoice)), "AK", 1)
    ossafe_ini_close()
    ossafe_savedata_save()
    global.msc = 0
    global.typer = 120
...
if (con == 50)
{
    facetype = 1
    ossafe_ini_open("undertale.ini")
    ini_write_real(("Flowey" + string(global.filechoice)), "IK", 1)
    ossafe_ini_close()
    ossafe_savedata_save()
    global.msc = 0
    global.typer = 120
...
if (con == 60)
{
    facetype = 1
    ossafe_ini_open("undertale.ini")
    ini_write_real(("Flowey" + string(global.filechoice)), "CHANGE", 1)
    ossafe_ini_close()
    ossafe_savedata_save()
    global.msc = 0
    global.typer = 120
...
if (con == 70)
{
    facetype = 1
    ossafe_ini_open("undertale.ini")
    ini_write_real(("Flowey" + string(global.filechoice)), "CHANGE", 2)
    ossafe_ini_close()
    ossafe_savedata_save()
    global.msc = 0
    global.typer = 120
...
if (con == 80)
{
    facetype = 1
    ossafe_ini_open("undertale.ini")
    ini_write_real(("Flowey" + string(global.filechoice)), "SPECIALK", 1)
    ossafe_ini_close()
    ossafe_savedata_save()
    global.msc = 0
    global.typer = 120
...
if (con == 100)
{
    facetype = 1
    ossafe_ini_open("undertale.ini")
    ini_write_real(("Flowey" + string(global.filechoice)), "EX", 1)
    ossafe_ini_close()
    ossafe_savedata_save()
    global.msc = 0
    global.typer = 120
...
if (con == 110)
{
    facetype = 1
    ossafe_ini_open("undertale.ini")
    ini_write_real(("Flowey" + string(global.filechoice)), "EX", 2)
    ossafe_ini_close()
    ossafe_savedata_save()
    global.msc = 0
    global.typer = 120
...
if (con == 120)
{
    facetype = 1
    ossafe_ini_open("undertale.ini")
    ini_write_real(("Flowey" + string(global.filechoice)), "EX", 3)
    ossafe_ini_close()
    ossafe_savedata_save()
    global.msc = 0
    global.typer = 120
...
if (con == 130)
{
    facetype = 1
    ossafe_ini_open("undertale.ini")
    ini_write_real(("Flowey" + string(global.filechoice)), "EX", 4)
    ossafe_ini_close()
    ossafe_savedata_save()
    global.msc = 0
    global.typer = 120
...
if (con == 140)
{
    facetype = 1
    ossafe_ini_open("undertale.ini")
    ini_write_real(("Flowey" + string(global.filechoice)), "EX", 5)
    ossafe_ini_close()
    ossafe_savedata_save()
    global.typer = 120
    global.msc = 0
