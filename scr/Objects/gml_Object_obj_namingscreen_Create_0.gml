...
if (ossafe_file_exists(namelistfile))
{
    var file = ossafe_file_text_open_read(namelistfile)
    var curline = ossafe_file_text_read_string(file)
    ossafe_file_text_readln(file)
    var progress = 0
    while (!ossafe_file_text_eof(file))
    {
        namelisten[progress] = ossafe_file_text_read_string(file)
        ossafe_file_text_readln(file)
        namelistjp[progress] = ossafe_file_text_read_string(file)
        ossafe_file_text_readln(file)
        namelistenm[progress] = ossafe_file_text_read_string(file)
        ossafe_file_text_readln(file)
        namelistjpm[progress] = ossafe_file_text_read_string(file)
        ossafe_file_text_readln(file)
        namelistallow[progress] = ossafe_file_text_read_real(file)
...
if ((!namelistok) && scr_debug())
    scr_debug_print("Could not read " + namelistfile)
