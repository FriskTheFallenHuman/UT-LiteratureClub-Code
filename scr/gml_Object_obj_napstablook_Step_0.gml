...
if (global.myfight == 2)
{
    if (whatiheard != -1)
    {
        if (global.heard == 0)
        {
            ...
            {
                global.msc = 0
                global.msg[0] = scr_gettext(("obj_napstablook_603" + string(char_name)))
                OBJ_WRITER.halt = 3
                iii = instance_create(global.idealborder[0], global.idealborder[2], OBJ_WRITER)
                with (iii)
                    halt = false
            ...
            if (whatiheard == 4)
            {
                ...
                {
                    if (mercymod < -400)
                        global.msg[0] = scr_gettext(("obj_napstablook_621" + string(char_name)))
                    if (mercymod == -400)
                        global.msg[0] = scr_gettext(("obj_napstablook_622" + string(char_name)))
                    if (mercymod == -300)
                        global.msg[0] = scr_gettext(("obj_napstablook_623" + string(char_name)))
                    if (mercymod == -200)
