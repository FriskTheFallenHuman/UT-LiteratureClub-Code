...
if (fac == 19)
{
    ...
    intr = ini_read_real(("Sans" + string(global.filechoice)), "Intro", 0)
    ini_write_real(("Sans" + string(global.filechoice)), "Intro", (intr + 1))
    ossafe_ini_close()
...
{
    ossafe_ini_open("undertale.ini")
    san_d = ini_read_real(("Sans" + string(global.filechoice)), "SK", 0)
    ini_write_real(("Sans" + string(global.filechoice)), "SK", (san_d + 1))
    ossafe_ini_close()
    ossafe_savedata_save()
