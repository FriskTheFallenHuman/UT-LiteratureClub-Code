    ...
    if (whatiheard != -1)
    {
        if (global.heard == 0)
        {
            ...
            if (whatiheard == 1)
            {
                global.msc = 0
                if global.charswap
                    global.msg[0] = scr_gettext(("obj_froggit_214a" + string(char_name)))
                global.msg[1] = scr_gettext("obj_froggit_214")
                OBJ_WRITER.halt = 3
                iii = instance_create(global.idealborder[0], global.idealborder[2], OBJ_WRITER)
                with (iii)
                    halt = false
            ...
            if (whatiheard == 3)
            {
                ...
                global.msc = 0
                if global.charswap
                    global.msg[0] = scr_gettext(("obj_froggit_225a" + string(char_name)))
                global.msg[1] = scr_gettext("obj_froggit_225")
                OBJ_WRITER.halt = 3
                iii = instance_create(global.idealborder[0], global.idealborder[2], OBJ_WRITER)
                with (iii)
                    halt = false
