...
switch argument0
{
    ...
    case 12:
        i = round(random(18))
        if (i == 0)
            global.msg[0] = scr_gettext(("SCR_TEXT_99" + string(char_name)))
        if (i == 1)
            global.msg[0] = scr_gettext(("SCR_TEXT_100" + string(char_name)))
        if (i == 2)
            global.msg[0] = scr_gettext(("SCR_TEXT_102" + string(char_name)))
        if (i == 3)
            global.msg[0] = scr_gettext(("SCR_TEXT_103" + string(char_name)))
        if (i > 3)
            global.msg[0] = scr_gettext(("SCR_TEXT_104" + string(char_name)))
        global.msg[0] += "/%"
        break
    case 14:
        i = round(random(20))
        if (i == 0 || i == 1)
            global.msg[0] = scr_gettext(("SCR_TEXT_111" + string(char_name)))
        if (i == 2)
            global.msg[0] = scr_gettext(("SCR_TEXT_112" + string(char_name)))
        if (i > 3)
            global.msg[0] = scr_gettext(("SCR_TEXT_113" + string(char_name)))
        if (i == 3)
            global.msg[0] = scr_gettext(("SCR_TEXT_114" + string(char_name)))
    ...
    case 15:
        if (room == room_ruins1)
        {
            if global.charswap
            {
                global.msg[0] = scr_gettext(("SCR_TEXT_127" + string(char_name)))
                global.msg[1] = scr_gettext(("SCR_TEXT_127b" + string(char_name)))
                global.msg[2] = scr_gettext("SCR_TEXT_128")
            }
            else
            {
                global.msg[0] = scr_gettext(("SCR_TEXT_127" + string(char_name)))
        ...
        if (room == room_ruins7)
        {
            global.msg[0] = scr_gettext(("SCR_TEXT_129" + string(char_name)))
            if global.charswap
                global.msg[1] = scr_gettext(("SCR_TEXT_129a" + string(char_name)))
            global.msg[2] = scr_gettext("SCR_TEXT_128")
        }
        if (room == room_ruins12A)
        {
            global.msg[0] = scr_gettext(("SCR_TEXT_131" + string(char_name)))
            global.msg[1] = scr_gettext("SCR_TEXT_132")
            if global.charswap
                global.msg[2] = scr_gettext(("SCR_TEXT_132a" + string(char_name)))
        }
        if (room == room_ruins19)
            global.msg[0] = scr_gettext(("SCR_TEXT_133" + string(char_name)))
        if (global.flag[202] >= 20)
            global.msg[0] = scr_gettext(("SCR_TEXT_134" + string(char_name)))
    ...
    case 220:
        ...
        global.msg[7] = scr_gettext(("SCR_TEXT_453" + string(char_name)))
    ...
    case 223:
        if (global.choice == 0)
        {
            ...
            ini_write_real(("Toriel" + string(global.filechoice)), "Bscotch", 2)
            ossafe_ini_close()
        ...
        if (global.choice == 1)
        {
            global.flag[46] = 1
            ossafe_ini_open("undertale.ini")
            ini_write_real(("Toriel" + string(global.filechoice)), "Bscotch", 1)
            ossafe_ini_close()
            ossafe_savedata_save()
        }
    ...
    case 508:
        ...
        if (global.flag[34] < 4)
        {
            ...
            global.msg[0] = scr_gettext(("SCR_TEXT_1606" + string(char_name)))
    ...
    case 509:
        if (global.choice == 0)
        {
            ...
            {
                if (global.flag[34] == 1)
                    global.msg[0] = scr_gettext(("SCR_TEXT_1624" + string(char_name)))
                if (global.flag[34] == 2)
                    global.msg[0] = scr_gettext(("SCR_TEXT_1625" + string(char_name)))
                if (global.flag[34] == 3)
                    global.msg[0] = scr_gettext(("SCR_TEXT_1626" + string(char_name)))
                if (global.flag[34] == 4)
                    global.msg[0] = scr_gettext(("SCR_TEXT_1628" + string(char_name)))
                if (global.flag[34] == 3 && global.flag[6] == 1)
                {
                    global.msg[0] = scr_gettext(("SCR_TEXT_1631" + string(char_name)))
                    global.flag[34] += 1
                }
            }
            if (noroom == 1)
                global.msg[0] = scr_gettext(("SCR_TEXT_1635" + string(char_name)))
        }
        if (global.choice == 1)
            global.msg[0] = scr_gettext(("SCR_TEXT_1639" + string(char_name)))
        break
    case 510:
        global.msg[0] = scr_gettext("SCR_TEXT_1644")
        global.msg[1] = scr_gettext(("SCR_TEXT_1645" + string(char_name)))
        global.msg[2] = scr_gettext(("SCR_TEXT_1646" + string(char_name)))
        global.msg[3] = scr_gettext(("SCR_TEXT_1647" + string(char_name)))
    ...
    case 514:
        doak = 0
        noroom = 0
        global.msg[0] = scr_gettext(("SCR_TEXT_1705" + string(char_name)))
    ...
    case 515:
        ...
        if (noroom == 0)
        {
            global.msg[0] = scr_gettext(("SCR_TEXT_1723" + string(char_name)))
            if (afford == 0)
                global.msg[0] = scr_gettext(("SCR_TEXT_1724" + string(char_name)))
        }
        if (noroom == 1)
            global.msg[0] = scr_gettext(("SCR_TEXT_1726" + string(char_name)))
        if (global.choice == 1)
    ...
    case 516:
        doak = 0
        noroom = 0
        global.msg[0] = scr_gettext(("SCR_TEXT_1736" + string(char_name)))
    ...
    case 517:
        ...
        if (noroom == 0)
        {
            global.msg[0] = scr_gettext(("SCR_TEXT_1754" + string(char_name)))
            if (afford == 0)
                global.msg[0] = scr_gettext(("SCR_TEXT_1724" + string(char_name)))
        }
        if (noroom == 1)
    ...
    case 518:
        ...
        global.msg[0] = scr_gettext(("SCR_TEXT_1771" + string(char_name)))
        if (noroom == 1)
            global.msg[0] = scr_gettext(("SCR_TEXT_1772" + string(char_name)))
        break
    case 519:
        doak = 0
        noroom = 0
        global.msg[0] = scr_gettext(("SCR_TEXT_1778" + string(char_name)))
    ...
    case 520:
        ...
        if (global.choice == 0)
            global.msg[0] = scr_gettext(("SCR_TEXT_1788" + string(char_name)))
        if (global.choice == 1)
            global.msg[0] = scr_gettext("SCR_TEXT_1789")
        if (global.flag[43] > 25)
            global.msg[0] = scr_gettext(("SCR_TEXT_1790" + string(char_name)))
        break
    case 521:
        doak = 0
        noroom = 0
        global.msg[0] = scr_gettext(("SCR_TEXT_1796" + string(char_name)))
    ...
    case 522:
        ...
        if (global.choice == 0)
        {
            global.msg[0] = scr_gettext(("SCR_TEXT_1806" + string(char_name)))
    ...
    case 523:
        ...
        global.msg[0] = scr_gettext(("SCR_TEXT_1817" + string(char_name)))
        if (noroom == 1)
            global.msg[0] = scr_gettext(("SCR_TEXT_1818" + string(char_name)))
        break
    case 524:
        doak = 0
        noroom = 0
    ...
    case 526:
        if (global.flag[6] == 0)
        {
            ...
            global.msg[0] = scr_gettext(("SCR_TEXT_1842" + string(char_name)))
            if (noroom == 1)
                global.msg[0] = scr_gettext(("SCR_TEXT_1843" + string(char_name)))
        }
        else
        {
            if (doak == 0)
            ...
            global.msg[0] = scr_gettext(("SCR_TEXT_1853" + string(char_name)))
            if (noroom == 1)
                global.msg[0] = scr_gettext(("SCR_TEXT_1854" + string(char_name)))
        }
        break
    case 527:
