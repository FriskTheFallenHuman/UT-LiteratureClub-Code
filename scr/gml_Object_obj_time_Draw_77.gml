...
if (global.flag[0] == 1 || (scr_murderlv() >= 1 && global.flag[27] == 0))
{
    for (var i = 0; i < sh; i += 2)
        draw_surface_part_ext(application_surface, 0, i, sw, 2, ((xx + floor(random((2 + screen_shake)))) - floor(random((2 + screen_shake)))), (yy + i), global.window_scale, global.window_scale, 16777215, 1)
}
else
