...
if (room == room_ruins13)
{
    ...
    if (chance >= 3)
    {
        global.msg[0] = scr_gettext(("obj_readable_room1_69_console_1" + string(char_name)))
        global.msg[1] = scr_gettext(("obj_readable_room1_69_console_2" + string(char_name)))
        global.msg[2] = scr_gettext(("obj_readable_room1_69_console_3" + string(char_name)))
        global.msg[3] = scr_gettext(("obj_readable_room1_69_console_4" + string(char_name)))
    }
    else
        global.msg[0] = scr_gettext(("obj_readable_room1_69" + string(char_name)))
}
...
if (room == room_torhouse1)
    global.msg[0] = scr_gettext(("obj_readable_room1_75" + string(char_name)))
if (room == room_asghouse1)
{
    global.msg[0] = scr_gettext(("obj_readable_room1_78" + string(char_name)))
    if (scr_murderlv() >= 16)
...
if (room == room_asghouse2)
    global.msg[0] = scr_gettext(("obj_readable_room1_82" + string(char_name)))
if (room == room_asrielroom)
    global.msg[0] = scr_gettext(("obj_readable_room1_83" + string(char_name)))
...
if (room == room_torhouse3)
{
    if global.charswap
    {
        global.msg[0] = scr_gettext(("obj_readable_room1_142" + string(char_name)))
        if (scr_murderlv() >= 1 && global.flag[0] == 1)
            global.msg[1] = scr_gettext(("obj_readable_room1_149" + string(char_name)))
        else
            global.msg[1] = scr_gettext(("obj_readable_room1_148" + string(char_name)))
        secret_jingle = 1
    }
    else
...
if (room == room_kitchen)
    global.msg[0] = scr_gettext(("obj_readable_room1_144" + string(char_name)))
if (room == room_kitchen_final)
{
    global.msg[0] = scr_gettext(("obj_readable_room1_147" + string(char_name)))
    if (scr_murderlv() >= 16)
