...
while (n <= stringpos)
{
    ...
    else if (ch == "\\")
    {
        ...
        else if (ch == "z")
        {
            ...
            if (sym == 4)
            {
                ...
                {
                    surface_set_target(editedsurf)
                    draw_sprite_ext(sym_s, 0, (myx + (random(shake) - (shake / 2))), ((myy + 10) + (random(shake) - (shake / 2))), 2, 2, 0, editedcolor, 1)
                    surface_reset_target()
                }
            }
        }
    ...
    else
    {
        ...
        if surface_exists(normalsurf)
        {
            ...
            else if (global.typer == 666 || global.typer == 34)
            {
                draw_set_font(fnt_wingdings)
                draw_text_transformed_color(finalx, (finaly - 2), myletter, scalex, scaley, angle, c_gray, c_gray, c_gray, c_gray, 0.5)
            ...
            else
            {
                if (global.inbattle == 0)
                    draw_text_transformed_color((finalx + 0.5), (finaly + 0.5), myletter, scalex, scaley, angle, c_dkgray, c_dkgray, c_navy, c_navy, 0.5)
