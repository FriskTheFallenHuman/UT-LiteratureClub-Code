...
if (menu_engage == 0)
{
    ...
    if (menu == 2)
    {
        if (menu_engage == 1 || keyboard_check_pressed(vk_right))
        {
            do
            {
    ...
    if (menu == 3)
    {
        if ((canchange == 1 && menu_engage == 1) || keyboard_check_pressed(vk_left) || keyboard_check_pressed(vk_right))
        {
    ...
    if (menu == 4)
    {
        if ((obj_time.j_ch == 1 && menu_engage == 1) || control_check_pressed(0))
        {
