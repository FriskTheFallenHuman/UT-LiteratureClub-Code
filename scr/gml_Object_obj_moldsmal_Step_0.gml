...
if (global.myfight == 2)
{
    if (whatiheard != -1)
    {
        if (global.heard == 0)
        {
            ...
            {
                global.msc = 0
                global.msg[0] = scr_gettext(("obj_moldsmal_412" + string(char_name)))
                if (global.monsteratk[myself] > 6)
                    global.msg[0] = scr_gettext(("obj_moldsmal_413" + string(char_name)))
                OBJ_WRITER.halt = 3
            ...
            if (whatiheard == 3)
            {
                global.flag[132] = 1
                global.msc = 0
                global.msg[0] = scr_gettext(("obj_moldsmal_422" + string(char_name)))
                OBJ_WRITER.halt = 3
                iii = instance_create(global.idealborder[0], global.idealborder[2], OBJ_WRITER)
                with (iii)
                    halt = false
            ...
            if (whatiheard == 1)
            {
                global.flag[132] = 1
                global.msc = 0
                global.msg[0] = scr_gettext(("obj_moldsmal_434" + string(char_name)))
                if global.charswap
                    global.msg[0] = scr_gettext(("obj_moldsmal_434a" + string(char_name)))
                OBJ_WRITER.halt = 3
                iii = instance_create(global.idealborder[0], global.idealborder[2], OBJ_WRITER)
                with (iii)
                    halt = false
