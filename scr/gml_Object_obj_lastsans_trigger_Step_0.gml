...
if (con == 1)
{
    ...
    sf2 = ini_read_real(("Sans" + string(global.filechoice)), "F", 0)
    ossafe_ini_close()
    if (sf2 >= 3 && murder == 1)
    {
        with (m)
...
if (con == 2)
{
    ...
    {
        ss = 1
        sans = scr_marker(920, (position_hack ? (obj_char.y + 10) : obj_char.y), spr_sans_l)
...
if (con == 4.1)
{
    ...
    {
        ossafe_ini_open("undertale.ini")
        endmet = ini_read_real(("Sans" + string(global.filechoice)), "EndMet", 0)
        ossafe_ini_close()
        if (endmet == 0)
        {
...
if (con == 5)
{
    ossafe_ini_open("undertale.ini")
    endmet = ini_read_real(("Sans" + string(global.filechoice)), "EndMet", 0)
    ini_write_real("Sans", ("EndMet" + string(global.filechoice)), 1)
    ml1 = ini_read_real(("Sans" + string(global.filechoice)), "MeetLv1", 0)
    pass = ini_read_real(("Sans" + string(global.filechoice)), "Pass", 0)
    ossafe_ini_close()
...
if (con == 6 && instance_exists(OBJ_WRITER) == 0)
{
    ossafe_ini_open("undertale.ini")
    ml1 = ini_read_real(("Sans" + string(global.filechoice)), "MeetLv1", 0)
    ini_write_real(("Sans" + string(global.filechoice)), "MeetLv1", (ml1 + 1))
    ossafe_ini_close()
    ossafe_savedata_save()
    global.currentsong = caster_load("music/chokedup.ogg")
    caster_loop(global.currentsong, 1, 1)
...
{
    ossafe_ini_open("undertale.ini")
    ml2 = ini_read_real(("Sans" + string(global.filechoice)), "MeetLv2", 0)
    ini_write_real(("Sans" + string(global.filechoice)), "MeetLv2", (ml2 + 1))
    ossafe_ini_close()
    ossafe_savedata_save()
    global.interact = 1
...
{
    ossafe_ini_open("undertale.ini")
    ml = ini_read_real(("Sans" + string(global.filechoice)), "MeetLv", 0)
    ini_write_real(("Sans" + string(global.filechoice)), "MeetLv", global.lv)
    ossafe_ini_close()
    ossafe_savedata_save()
    global.facechoice = 3
...
if (con == 30 && instance_exists(OBJ_WRITER) == 1)
{
    ...
    {
        ossafe_ini_open("undertale.ini")
        ini_write_real(("Sans" + string(global.filechoice)), "Pass", 1)
        ossafe_ini_close()
        ossafe_savedata_save()
    }
    ...
    {
        ossafe_ini_open("undertale.ini")
        ini_write_real(("Sans" + string(global.filechoice)), "Pass", 2)
        ossafe_ini_close()
        ossafe_savedata_save()
    }
    ...
    {
        ossafe_ini_open("undertale.ini")
        ini_write_real(("Sans" + string(global.filechoice)), "Pass", 3)
        ossafe_ini_close()
        ossafe_savedata_save()
    }
}
...
if (con == 100)
{
    ...
    mc = scr_marker(obj_char.x, obj_char.y, obj_char.rsprite)
    mc.depth = obj_char.depth
    ...
    global.typer = 17
    ossafe_ini_open("undertale.ini")
    sansf = ini_read_real(("Sans" + string(global.filechoice)), "F", 0)
    sansk = ini_read_real(("Sans" + string(global.filechoice)), "SK", 0)
    ossafe_ini_close()
