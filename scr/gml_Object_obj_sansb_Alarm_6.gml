...
if (hit_try > hit_reached)
{
    ...
    if (hit_try == 13)
    {
        ...
        SS = ini_read_real(("Sans" + string(global.filechoice)), "SS", 0)
        MP = ini_read_real(("Sans" + string(global.filechoice)), "MP", 0)
        ini_write_real(("Sans" + string(global.filechoice)), "MP", (MP + 1))
        ossafe_ini_close()
    ...
    if (hit_try == 14)
    {
        ossafe_ini_open("undertale.ini")
        SS = ini_read_real(("Sans" + string(global.filechoice)), "SS", 0)
        SS2 = ini_read_real(("Sans" + string(global.filechoice)), "SS2", 0)
        if (SS > 0)
            ini_write_real(("Sans" + string(global.filechoice)), "SS2", (SS2 + 1))
        ossafe_ini_close()
        if (drama == 2)
            caster_free(d_music)
        global.flag[20] = 1
...
if (mercy_death == 1)
{
    ...
    ossafe_ini_open("undertale.ini")
    SS = ini_read_real(("Sans" + string(global.filechoice)), "SS", 0)
    ini_write_real(("Sans" + string(global.filechoice)), "SS", (SS + 1))
    ossafe_ini_close()
}
global.typer = 109
global.border = 35
