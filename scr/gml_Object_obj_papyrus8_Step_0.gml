...
if (conversation == 8)
{
    ...
    PP = ini_read_real(("Papyrus" + string(global.filechoice)), "PS", 0)
    ossafe_ini_close()
    global.msc = 0
    global.typer = 19
    global.facechoice = 0
...
{
    ossafe_ini_open("undertale.ini")
    PS = ini_read_real(("Papyrus" + string(global.filechoice)), "PS", 0)
    ini_write_real(("Papyrus" + string(global.filechoice)), "PS", (PS + 1))
    ossafe_ini_close()
